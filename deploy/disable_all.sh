...
WHALE_UNITS=(whale-watch whale-signals)
...
echo "To re-enable poly:"
echo "    systemctl enable --now poly-watch.timer whale-watch.timer whale-signals.timer poly-arbs.timer poly-paper-settle.timer"
